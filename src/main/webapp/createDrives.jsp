...
<script type="text/javascript">
	function checkCtc(){
		...
		if(!document.forms["checkingInput"]["cse"].checked && !document.forms["checkingInput"]["ise"].checked && !document.forms["checkingInput"]["eee"].checked && !document.forms["checkingInput"]["ece"].checked && !document.forms["checkingInput"]["me"].checked)
		{
			alert("Select atleast one eligible stream");
			return false;
		}
	}
</script>
...
<body>
	<header class="header">
      ...
      <ul class="main-nav">
          ...
          <li><a id="active" href="createDrives.jsp">create drives</a></li>
  ...
  <h2>ENTER DRIVE DETAILS</h2>
  <form method="post" name="checkingInput" action="Logics" onsubmit="return checkCtc()">
    <div class="user-box">
	...
	<div class="user-box">
      <input type="text" name="jobDesc" maxlength="250" required>
      <label>JOB DESCRIPTION</label>
    </div>
    <div class="user-box">
      <input type="text" name="campusDesc" maxlength="250" required>
    ...
    <div class="user-box">
      <input type="text" name="ctc" maxlength="8" required>
      <label>CTC</label>
    </div>
    <div class="user-box">
    ...
    <input id=forgot type="submit" name=create value="create">
  </form>
</div>
	</div>
</body>
