...
<body>
  ...
  <h2>Enter a Request Message</h2>
  <form method="post" name="checkingInput" action="Logics">
  	<div class="user-box">
      <input style=color:green; type="text" name="usn" value=<%=request.getAttribute("usn")%> readonly>
      <label>usn</label>
    </div>
    <div class="user-box">
      <textarea name="unblockRequestMsg" maxlength="100" required></textarea>
      <label>Message</label>
    </div>
    <input id=forgot type="submit" name=unblockRequest value=submit><%}}%>
  </form>
</div>
	</div>
</body>
