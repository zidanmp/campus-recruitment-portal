...
<div class="back"><a href="Logics?viewDrives=true">PREVIOUS</a></div>
	<div class="drive">
		<div class="login-box">
  ...
  <form method="post" name="checkingInput" action="Logics">
    ...
    <div class="user-box">
      <input type="text" name="title" value="<%= job.getJob_title()%>" readonly>
      <label>JOB TITLE (DESIGNATION)</label>
    </div>
    <div class="user-box">
      <input type="text" name="companyName" value="<%= job.getCompany_name()%>" readonly>
      <label>COMPANY NAME</label>
    </div>
	<div class="user-box">
		<textarea rows="4" cols="65" name="jobDesc" maxlength=250 readonly><%= job.getJob_description()%></textarea>
      <label>JOB DESCRIPTION</label>
    </div>
    <div class="user-box">
		<textarea rows="4" cols="65" name="campusDesc" maxlength=250 readonly><%= job.getCampus_description()%></textarea>
      <label>CAMPUS DESCRIPTION</label>
    </div>
    <div class="user-box">
      <input type="text" name="location" value="<%= job.getLocation()%>" readonly>
      <label>JOB LOCATION</label>
    </div>
    <div class="user-box">
      <input type="text" name="ctc" value="<%= job.getCtc()%>" maxlength="8" readonly>
      <label>CTC</label>
    </div>
    <div class="user-box">
      <input type="text" name="cgpa" value="<%= job.getMin_cgpa()%>" readonly>
      <label>MINIMUM CGPA</label>
      </div>
  <div class="user-box">
      <input type="text" name="cgpa" value="<%= job.getDepts_eligible().toUpperCase()%>" readonly>
      <label>Eligible Departments</label>
      </div>
    <input id=forgo type="submit" name="apply" value="apply">
  </form>
  <%}}} %>
</div>
	</div>
