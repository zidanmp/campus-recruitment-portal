...
<div class="drives">
	...
	<%
	if((request.getAttribute("students")==null)&&(request.getAttribute("blockedStudents")==null)){%>
		<div class="head"><center>No Students have registered</center></div>
	<%}else{ 
		if(request.getAttribute("students")!=null){%>
		<div class="heading"><center>STUDENTS</center></div>
	<%ArrayList students;
	students=(ArrayList)request.getAttribute("students");
	for(Object obj : students){
		String[] student=(String[])obj;%>
		<a href="Logics?usn=<%= student[0]%>&studentDetail=true"><table>
			<tr><td><%= student[0]%></td><td><%= student[1] %></td></tr>
		</table></a>
	<%}}
	if(request.getAttribute("blockedStudents")!=null)
	{%>
	<div class="heading"><center>BLOCKED STUDENTS</center></div>
		<%ArrayList blockedStudents;
		blockedStudents=(ArrayList)request.getAttribute("blockedStudents");
		for(Object obj : blockedStudents){
			String[] blockedStudent=(String[])obj;%>
			<a href="Logics?usn=<%= blockedStudent[0]%>&studentDetail=true"><table>
				<tr><td><%= blockedStudent[0]%></td><td><%= blockedStudent[1] %></td></tr>
			</table></a>
		<%
	}}
	}%>
