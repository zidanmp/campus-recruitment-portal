...
<div class="drives">
	...
	for(Object obj : drives){
		...
		<a href="Logics?company=<%= drive[0]%>&title=<%= drive[1] %>&indetailApplications=true"><table>
	...
	<div class="heading"><center>CLOSED DRIVES</center></div>
		...
		for(Object obj : closedDrives){
			...
			<a href="Logics?company=<%= closedDrive[0]%>&title=<%= closedDrive[1] %>&indetailApplications=true"><table>
	...
	<div class="heading"><center>CANCELLED DRIVES</center></div>
		...
		for(Object obj : cancelledDrives){
			...
			<a href="Logics?company=<%= cancelledDrive[0]%>&title=<%= cancelledDrive[1] %>&indetailApplications=true"><table>
