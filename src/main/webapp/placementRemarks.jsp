...
<div class="back"><a href="Logics?view=true">PREVIOUS</a></div>
	<div class="drive">
		...
		<h3><% if(request.getAttribute("errormsg")!=null){out.println(request.getAttribute("errormsg"));} else{String applicationid=(String)request.getAttribute("applicationid"); %></h3>
  <h2>Add Remarks</h2>
  <form method="post" action="Logics">
      <input style=color:green; type="text" name="applicationid" value=<%= applicationid%> hidden>
	<div class="user-box">
	  <textarea rows="3" cols="65" name="remarks" maxlength=100 placeholder="Enter the remarks here.." required></textarea>
      <label>Remarks</label>
    </div>
    <input id=forgot type="submit" name=placementRemarks value="submit">
  </form>
  <%} }%>
</div>
</div>
