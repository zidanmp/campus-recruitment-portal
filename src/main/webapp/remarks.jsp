...
<body>
	<header class="header">
      ...
      <ul class="main-nav">
          ...
          <li><a href="#">Unblock Requests</a></li>
...
<div class="back"><a href="Logics?view=true">PREVIOUS</a></div>
	<div class="drive">
		...
		<h3><% if(request.getAttribute("errormsg")!=null){out.println(request.getAttribute("errormsg"));} else{int jobid=((Integer)request.getAttribute("jobid")).intValue(); %></h3>
  <h2>Add Remarks</h2>
  <form method="post" action="Logics">
  	<div class="user-box">
      <input style=color:green; type="text" name="jobid" value=<%=jobid %> readonly>
      <label>JOB ID</label>
    </div>
	<div class="user-box">
	  <textarea rows="3" cols="65" name="remarks" maxlength=100 placeholder="Enter the remarks here.."></textarea>
      <label>Remarks</label>
    </div>
    <input id=forgot type="submit" name=closeremarks value="submit">
  </form>
  <%} }%>
</div>
</div>
