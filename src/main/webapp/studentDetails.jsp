...
<script type="text/javascript">
	function checkInput(){
		var value=document.forms["checkingInput"]["attendance"].value;
		if(isNaN(value))
		{
			alert("Attendance should be a number");
			return false;
		}
	}
</script>
...
<div class="back"><a href="Logics?viewStudents=true">PREVIOUS</a></div>
  ...
  <form method="post" name="checkingInput" action="Logics" onsubmit="return checkInput()">
	...
	<div class="user-box">
		<input type="text" name="phone" value="<%= student.getPhone()%>" readonly>
      <label>PHONE</label>
    </div>
    <div class="user-box">
		<input type="text" name="dept" value="<%= student.getDept_name()%>" readonly>
    ...
    <div class="user-box">
      <input type="text" name="attendance" value="<%= student.getAttendance()%>" required>
      <label>ATTENDANCE</label>
    </div>
    <% if(student.getAttendance()!=3){%>
    <input id=forgot type="submit" name=block value="block">
    <input id=forgot type="submit" name=updateAtt value="update attendance">
    <input id=forgot type="submit" name=deleteStudent value="delete">
    <%} else{%>
    <input id=forgo type="submit" name=unblock value="unblock">
    <input id=forgot type="submit" name=deleteStudent value="delete">
    <%} %>
  </form>
  <%} %>
